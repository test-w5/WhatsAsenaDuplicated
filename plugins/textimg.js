...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/ph?text=${topText}&text2=${bottomText}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})
    ...
    var webimage = await axios.get(`https://api.lolhuman.xyz/api/ephoto1/wetglass?apikey=e228d999bd914b35bffb7546&text=${match[1]}`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'W5-BOT'})
    ...
    Asena.addCommand({pattern: 'silverplaybutton ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'goldplaybutton ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'multicolor3d ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'galaxywallpaper ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'lighttext ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'beautifulflower ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.document, {filename: 'W5-BOT.png', mimetype: Mimetype.png})
    ...
    var webimage = await axios.get(`https://docs-jojo.herokuapp.com/api/qrcode?text=${match[1]}`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({pattern: '3davengers ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3davengers?text=${topText}&text2=${bottomText}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/marvelstudios?text=${topText}&text2=${bottomText}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })

   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    
    Asena.addCommand({pattern: 'marvelstd ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/marvel?text=${topText}&text2=${bottomText}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/lionlogomascot?text=${topText}&text2=${bottomText}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/pabjigaqi?text=${topText}&text2=${bottomText}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/photooxy/flaming?text=${match[1]}&APIKEY=63c57b77f6b660c1`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    
    Asena.addCommand({pattern: 'smoketype ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText, middleText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})
    ...
    Asena.addCommand({pattern: 'codwarzone ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})
    ...
    Asena.addCommand({pattern: 'rero ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
  
    var webimage = await axios.get(`https://api.xteam.xyz/randomimage/ero?APIKEY=63c57b77f6b660c1=${match[1]}`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    Asena.addCommand({pattern: 'rass ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
  
    var webimage = await axios.get(`https://api.xteam.xyz/randomimage/ass?APIKEY=63c57b77f6b660c1=${match[1]}`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    Asena.addCommand({pattern: 'rpussy ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
  
    var webimage = await axios.get(`https://api.xteam.xyz/randomimage/pussy?APIKEY=63c57b77f6b660c1=${match[1]}`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    Asena.addCommand({pattern: 'rbdsm ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
  
    var webimage = await axios.get(`https://api.xteam.xyz/randomimage/bdsm?APIKEY=63c57b77f6b660c1=${match[1]}`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    Asena.addCommand({pattern: 'rpanties ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
  
    var webimage = await axios.get(`https://api.xteam.xyz/randomimage/panties?APIKEY=63c57b77f6b660c1=${match[1]}`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, quoted: message.data, caption: 'W5-BOT'})

    }));
    Asena.addCommand({pattern: 'rmstrb ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
  
    var webimage = await axios.get(`https://api.xteam.xyz/randomimage/mstrb?APIKEY=63c57b77f6b660c1=${match[1]}`, { responseType: 'arraybuffer' })
