...
module.exports = {
    ...
    YTSONG: process.env.YT_SG === undefined ? 'W5-BOT' : process.env.YT_SG,
    ...
    RBGVIDEO_API_KEY: process.env.REMOVE_BG_VIDEO_API_KEY === undefined ? false : process.env.REMOVE_BG_VIDEO_API_KEY,
